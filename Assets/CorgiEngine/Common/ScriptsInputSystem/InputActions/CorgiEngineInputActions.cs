...
namespace MoreMountains.CorgiEngine
{
    ...
    ""controlSchemes"": [
        ...
        {
            Debug.Assert(!m_PlayerControls.enabled, "This will cause a leak and performance issues, CorgiEngineInputActions.PlayerControls.Disable() has not been called.");
        }
